...
HH <- ggplot(Sharedata_final, aes(x=hhsize_update_ca)) +
  ...
  labs(x = "Tamaño vivienda", y = 'Frecuencias', 
       title = 'Histograma variable hhsize_update_ca',
       caption =
         paste0("Autora: Lucía Pascual Martínez | "))  
...
SATISLIFE <- ggplot(Sharedata_final, aes(x=satisfactionlife)) +
  geom_histogram(col='black', fill="#8cc8bc", binwidth = 1) +
  labs(x = "Satisfación con la vida", y = 'Frecuencias', 
       title = 'Histograma variable satisfactionlife',
       caption =
         paste0("Autora: Lucía Pascual Martínez | "))  
# Anadimos al diagrama de barras la media, mediana y varianza de la variable
...
STRINDEX <- ggplot(Sharedata_final, aes(x=StringencyIndex)) +
  geom_histogram(col='black', fill="#8cc8bc") +
  labs(x = "Índice Stringency", y = 'Frecuencias', 
       title = 'Histograma variable StringencyIndex',
       caption =
         paste0("Autora: Lucía Pascual Martínez | "))  
# Anadimos al diagrama de barras la media, mediana y varianza de la variable
...
GOVERME <- ggplot(Sharedata_final, aes(x=GovernmentResponseIndex)) +
  geom_histogram(col='black', fill="#8cc8bc") +
  labs(x = "Índice GovernmentResponse", y = 'Frecuencias', 
       title = 'Histograma variable GovernmentResponseIndex',
       caption =
         paste0("Autora: Lucía Pascual Martínez | "))  
# Anadimos al diagrama de barras la media, mediana y varianza de la variable
...
ECONINDEX <- ggplot(Sharedata_final, aes(x=EconomicSupportIndex)) +
  ...
  labs(x = "ïndice EconomicSupport", y = 'Frecuencias', 
       title = 'Histograma variable EconomicSupportIndex',
       caption =
         paste0("Autora: Lucía Pascual Martínez | "))  
# Anadimos al diagrama de barras la media, mediana y varianza de la variable
...
CONTINDEX <- ggplot(Sharedata_final, aes(x=ContainmentHealthIndex)) +
  ...
  labs(x = "Indice ContainmentHealth", y = 'Frecuencias', 
       title = 'Histograma variable ContainmentHEalthIndex',
       caption =
         paste0("Autora: Lucía Pascual Martínez | "))  
# Anadimos al diagrama de barras la media, mediana y varianza de la variable
...
DEATHS <- ggplot(Sharedata_final, aes(x=ConfirmedDeaths)) +
  geom_histogram(col='black', fill="#8cc8bc") +
  labs(x = "Muertes de COVID confirmadas", y = 'Frecuencias', 
       title = 'Histograma variable ConfirmedDeaths',
       caption =
         paste0("Autora: Lucía Pascual Martínez | "))  
# Anadimos al diagrama de barras la media, mediana y varianza de la variable
...
CASES <- ggplot(Sharedata_final, aes(x=ConfirmedCases)) +
  geom_histogram(col='black', fill="#8cc8bc") +
  labs(x = "Casos de covid confirmados", y = 'Frecuencias', 
       title = 'Histograma variable ConfirmedCases',
       caption =
         paste0("Autora: Lucía Pascual Martínez | "))  
# Anadimos al diagrama de barras la media, mediana y varianza de la variable
...
AGEHIST <- ggplot(Sharedata_final, aes(x=age)) +
  geom_histogram(col='black', fill="#8cc8bc") +
  labs(x = "Edad", y = 'Frecuencias', 
       title = 'Histograma variable Edad',
       caption =
         paste0("Autora: Lucía Pascual Martínez | "))  
# Anadimos al diagrama de barras la media, mediana y varianza de la variable
